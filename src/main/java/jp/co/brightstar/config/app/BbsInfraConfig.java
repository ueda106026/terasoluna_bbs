 ...
 */
@Configuration
@EnableJpaRepositories("jp.co.brightstar.domain.repository")
@Import({ BbsEnvConfig.class })
public class BbsInfraConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        bean.setPackagesToScan("jp.co.brightstar.domain.model");
