package jp.co.brightstar.config.app;
...
@ComponentScan(basePackages = { "jp.co.brightstar.domain" })
@Import({ BbsInfraConfig.class,
    BbsCodeListConfig.class })
public class BbsDomainConfig {
     ...
     * @see jp.co.brightstar.config.app.ApplicationContextConfig#exceptionLogger()
